 ...
 *
 */
class CRM_Report_Form_Mypage_SummaryContact extends CRM_Report_Form {
  ...
  function __construct() {
	...
	//$res = civicrm_api('contact', 'getoptions', $params); 
	//print_r($res);
	//$options = CRM_Core_PseudoConstant::get('CRM_Core_DAO_CustomField', 'custom_9');
 ...
 function where() {
	// echo '<pre>';print_r($this->_formValues);die;
	$issues = CRM_Utils_Array::value( 'custom_8_value', $this->_formValues );
    $this->_where="where issues_8 =$issues";
